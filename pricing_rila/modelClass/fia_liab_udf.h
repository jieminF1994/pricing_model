...
// crediting_cap_spr_fix_index0_aig 
double fia_liab_crediting_cap_spr_fix_index0_aig(int t);
...
// Discount Rate for PV shifted 
double fia_liab_disc_rate_pv_shifted_aig(int t);
...
// RILA trading cost 
double fia_liab_hedge_rila_trading_cost_aig(int t);

// PV CF using discount rate 1 
double fia_liab_hedge_rila_trading_cost_aig_pv_cf_disc_rate_1(int t);

// PV CF using AIG Curve IC UEL 
double fia_liab_hedge_rila_trading_cost_aig_pv_cf_disc_rate_aig_curve_ic_uel_aig(int t);

// PV CF using AIG Curve No UEL 
double fia_liab_hedge_rila_trading_cost_aig_pv_cf_disc_rate_aig_curve_no_uel_aig(int t);

// PV CF AIG Curve UEL 
double fia_liab_hedge_rila_trading_cost_aig_pv_cf_disc_rate_aig_curve_uel_aig(int t);
...
// print out initial opt cost 
double fia_liab_init_opt_cost_print_aig(int t);

// initial option cost 
double fia_liab_initial_opt_cost_aig(int t);
...
// New money rate used for RILA dynamic lapse 
double fia_liab_lapse_dyn_new_money_rate_aig(int t);

// Additional Lapse Due to ISL 2019: 
double fia_liab_lapse_dyn_rate_add_isl_2019_aig(int t);

// Base Product Dynamic Lapse Addition for RILA 
double fia_liab_lapse_dyn_rila_base_aig(int t);

// ArcTan Dynamic Lapse Multiplier for ROP DB 
double fia_liab_lapse_dyn_rop_db_mult_aig(int t);
...
// Simplified calculation for liability duration 
double fia_liab_liab_duration_aig(int t);
...
// Cumulative premium bonus amounts: 
double fia_liab_prem_bonus_cumul_b_bef_aig(int t);

// Cumulative premium bonus amounts paid: 
double fia_liab_prem_bonus_cumul_e_aig(int t);

// Cumulative gross premium bonuses credited: 
double fia_liab_prem_bonus_cumul_e_bef_aig(int t);

// Prem Bonus Recapture Base as of Beginning of Month Before Any Charges: 
double fia_liab_prem_bonus_recapture_base_b_bef_aig(int t);

// Premium Bonus Recapture Base at the End of Month: 
double fia_liab_prem_bonus_recapture_base_e_aig(int t);

// Premium bonus amount that can be recaptured: 
double fia_liab_prem_bonus_recapture_base_e_bef_aig(int t);
...
// Premium Bonus Recapture Inforce Amount at the End of the Month: 
double fia_liab_prem_bonus_recapture_inf_e_aig(int t);

// Premium Bonus Recaputure Amount Inforce at the End of the Month: 
double fia_liab_prem_bonus_recapture_inf_e_bef_aig(int t);

// Cumulative premium bonus amounts recaptured: 
double fia_liab_prem_bonus_recaptured_cumul_e_aig(int t);

// Cumulative recaptured premium bonus amounts: 
double fia_liab_prem_bonus_recaptured_cumul_e_bef_aig(int t);
...
double fia_liab_prem_cumul_prop_wdl_aig(int t);

// Premium Cumulative net of proportional Withdrawals End of Month Before Claims 
double fia_liab_prem_cumul_prop_wdl_bef_aig(int t);
...
// PV cash flow EOM 
double fia_liab_pv_bom_cf_disc_uel_crbg(int t);

// PV claims using AIG Curve UEL 
double fia_liab_pv_cash_flow_liab_dur_aig(int t);

// PV cash flow EOM 
double fia_liab_pv_eom_cf_disc_uel_crbg(int t);

// PV shifted CF AIG Curve UEL 
double fia_liab_pv_shifted_cash_flow_liab_dur_aig(int t);

// PV cash flow using uel 
double fia_liab_pv_total_cf_disc_uel_crbg(int t);
...
// Interim value 
double fia_liab_rila_interim_value_beg_term_aig(int t);

// Interim value 
double fia_liab_rila_interim_value_dapv_e_aig(int t);

// Interim value 
double fia_liab_rila_interim_value_e_aig(int t);

// Interim value 
double fia_liab_rila_interim_value_e_bef_aig(int t);

// Interim value 
double fia_liab_rila_interim_value_fiapv_e_aig(int t);

// Interim Value growth rate 
double fia_liab_rila_interim_value_growth_aig(int t);

// Interim value 
double fia_liab_rila_interim_value_tc_e_aig(int t);

// Interim value 
double fia_liab_rila_strat_base_b_aig(int t);

// Interim value 
double fia_liab_rila_strat_base_e_aig(int t);
...
// Rop Chg for death benefit 
double fia_liab_rop_chg_aig(int t);

// PV CF using discount rate 1 
double fia_liab_rop_chg_aig_pv_cf_disc_rate_1(int t);

// PV CF using AIG Curve IC UEL 
double fia_liab_rop_chg_aig_pv_cf_disc_rate_aig_curve_ic_uel_aig(int t);

// PV CF using AIG Curve No UEL 
double fia_liab_rop_chg_aig_pv_cf_disc_rate_aig_curve_no_uel_aig(int t);

// PV CF AIG Curve UEL 
double fia_liab_rop_chg_aig_pv_cf_disc_rate_aig_curve_uel_aig(int t);

// ROP chg Partial Bef Dth Aig 
double fia_liab_rop_chg_partial_bef_dth_aig(int t);

// ROP Partial Bef surr Aig 
double fia_liab_rop_chg_partial_bef_surr_aig(int t);

// ROP Partial fee EOM 
double fia_liab_rop_chg_partial_e_aig(int t);
...
// Strategy return 
double fia_liab_strategy_return_aig(int t);
...
// Uniform Random Number Variable Stream 4: 
double fia_liab_uniform_rands_4_aig(int t);

// Uniform Random Number Variable Stream 6: for brownian bridge 
double fia_liab_uniform_rands_brownian_bridge_aig(int t);

// Uniform Random Number Variable Stream 5: for non-US return 
double fia_liab_uniform_rands_non_us_return_aig(int t);

// Uniform Random Number Variable Stream for performance lock: 
double fia_liab_uniform_rands_perf_lock_aig(int t);

// Valn Tgt Deterministic Crbg 
double fia_liab_valn_tgt_deterministic_crbg(int t);
...
// Vm21 Pv Claims Deterministic - current 
double fia_liab_vm21_pv_claims_det_curr_crbg(int t);

// Vm21 Pv Claims Deterministic - initial 
double fia_liab_vm21_pv_claims_det_init_crbg(int t);

// Vm21 Pv Claims Deterministic 
double fia_liab_vm21_pv_claims_deterministic_crbg(int t);
...
// valn_deterministic_flag 
int  fia_liab_valn_deterministic_flag_crbg();
