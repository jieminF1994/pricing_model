...
/*
return max(0.0, fund_val_b_aig(t) 
				* (pow(1.0 + crediting_rate(t), mths_to_closest_eocy_or_eopy / 12.0)
				   * pow(1.0 + min(crediting_rate(t), max_crediting_rate), mths_to_eopy / 12.0) - 1.0));
*/
...
for (int i = 0; i < fia->sm_fia_account.size(); i++)
{
	...
	if (t == 1)
	{
		part_rate = fia->sm_fia_account[i]->crediting_part_rate_aig(fia->res_period);//WTW - Gen2 - RebasedModelObjectCanOnlyBeCalledFromARebasingFormula
	}
	else
	{
...
if (crediting_rate_defn_local == FIXED_RATE)  //Fixed Strategy
{
	...
	fixed_rate_num = fixed_rate * fia->sm_fia_account[0]->fund_val_e(fia->res_period);
	net_opt_value = 0.0;
}
...
else 
{
	...
	else
	{
				  ...
				  crediting_dyn_lever_local == DYNAMIC_PARTICIPATION) //Dynamic par strategy
		{
			...
			{
				string err_msg = "fiacarvm_liab->crediting_rate_index0_aig: division by zero.";
		...
		{				
			...
			else 
			{
				...
				if (crediting_dyn_lever_local == DYNAMIC_TRIGGER)
				{
					...
					net_opt_value = trigger_rate_cv * option_cost_one_percent;
				}
			//20230118 SJ END
				else
				{
					...
					{
						string warning_msg = "fiacarvm_liab->crediting_rate_index0_aig: You're running a crediting rate strategy that has not yet been coded into the CARVM submodel.";
...
else
{
	...
	fund_val_cv = max(0, fund_val_prev + credited_int_cv);
}
...
if (!fia->gmwb_flag || calc_base_res_only_aig == "Yes")//20230127 SJ: For XOL deal, calculate base stat res only. No GMWB fee assessed.
	return NO_AVG;
...
if (gmwb_flex_defn_aig == YES && glb_withdrls_have_begun_aig == "No")  // DTL 20201026
{
...
if (fia->crediting_type_dyn_defn_aig == DYNAMIC_SWITCHING_ON
...
else
{
	...
	bonus_recapture = fia->prem_bonus_recapture_base_e_aig(fia->res_period) * prem_bonus_recapture_pct_carvm_aig;//WTW - Gen2 - RebasedModelObjectCanOnlyBeCalledFromARebasingFormula
...
void FIACARVM_LIAB::set_hidden_variables(int policy_month)
{
	...
	if (fia->gmwb_flag)
	{
		...
		if (fia->pol_yr(policy_month + 1) <= fia->gmwb_req_yrs_wait + fia->gmwb_exercise_yrs)
		{
		...
		{
			gmwb_wait_period_aig = fia->gmwb_req_yrs_wait + fia->gmwb_exercise_yrs;
		}
	}
	else 
	{
...
const CashFlowCommonData FIACARVM_LIAB::mCFStaticData_0[] = 
{
	...
	CashFlowCommonData(39, "gmwb_ann_benefits", "fiacarvm_liab_gmwb_ann_benefits",  "gmwb_ann_benefits",  CashFlowCommonData::SUM,
                     (dPFi)(dPXi)&FIACARVM_LIAB_UDF::fiacarvm_liab_gmwb_ann_benefits, 'E','N', '3', 'N', (size_t)&modelOffset->gmwb_ann_benefits),
	CashFlowCommonData(40, "gmwb_ann_benefits_pv", "fiacarvm_liab_gmwb_ann_benefits_pv",  "gmwb_ann_benefits_pv",  CashFlowCommonData::SUM,
                     (dPFi)(dPXi)&FIACARVM_LIAB_UDF::fiacarvm_liab_gmwb_ann_benefits_pv, 'E','N', '3', 'N', (size_t)&modelOffset->gmwb_ann_benefits_pv),
	CashFlowCommonData(41, "gmwb_chg", "fiacarvm_liab_gmwb_chg",  "gmwb_chg",  CashFlowCommonData::SUM,
                     (dPFi)(dPXi)&FIACARVM_LIAB_UDF::fiacarvm_liab_gmwb_chg, 'E','N', '3', 'N', (size_t)&modelOffset->gmwb_chg),
	CashFlowCommonData(42, "gmwb_income_base_b_aig", "fiacarvm_liab_gmwb_income_base_b_aig",  "gmwb_income_base_b_aig",  CashFlowCommonData::SUM,
                     (dPFi)(dPXi)&FIACARVM_LIAB_UDF::fiacarvm_liab_gmwb_income_base_b_aig, 'E','Y', '3', 'N', (size_t)&modelOffset->gmwb_income_base_b_aig),
	CashFlowCommonData(43, "gmwb_income_base_b_bef_aig", "fiacarvm_liab_gmwb_income_base_b_bef_aig",  "gmwb_income_base_b_bef_aig",  CashFlowCommonData::SUM,
	...
	CashFlowCommonData(44, "gmwb_income_base_e_aig", "fiacarvm_liab_gmwb_income_base_e_aig",  "gmwb_income_base_e_aig",  CashFlowCommonData::SUM,
                     (dPFi)(dPXi)&FIACARVM_LIAB_UDF::fiacarvm_liab_gmwb_income_base_e_aig, 'E','Y', '3', 'N', (size_t)&modelOffset->gmwb_income_base_e_aig),
	CashFlowCommonData(45, "gmwb_income_base_e_bef_aig", "fiacarvm_liab_gmwb_income_base_e_bef_aig",  "gmwb_income_base_e_bef_aig",  CashFlowCommonData::SUM,
	...
	CashFlowCommonData(46, "gmwb_income_base_ny_b_aig", "fiacarvm_liab_gmwb_income_base_ny_b_aig",  "gmwb_income_base_ny_b_aig",  CashFlowCommonData::SUM,
                     (dPFi)(dPXi)&FIACARVM_LIAB_UDF::fiacarvm_liab_gmwb_income_base_ny_b_aig, 'E','Y', '3', 'N', (size_t)&modelOffset->gmwb_income_base_ny_b_aig),
	CashFlowCommonData(47, "gmwb_income_base_ny_b_bef_aig", "fiacarvm_liab_gmwb_income_base_ny_b_bef_aig",  "gmwb_income_base_ny_b_bef_aig",  CashFlowCommonData::SUM,
	...
	CashFlowCommonData(48, "gmwb_income_base_ny_e_aig", "fiacarvm_liab_gmwb_income_base_ny_e_aig",  "gmwb_income_base_ny_e_aig",  CashFlowCommonData::SUM,
                     (dPFi)(dPXi)&FIACARVM_LIAB_UDF::fiacarvm_liab_gmwb_income_base_ny_e_aig, 'E','Y', '3', 'N', (size_t)&modelOffset->gmwb_income_base_ny_e_aig),
	CashFlowCommonData(49, "gmwb_income_base_ny_e_bef_aig", "fiacarvm_liab_gmwb_income_base_ny_e_bef_aig",  "gmwb_income_base_ny_e_bef_aig",  CashFlowCommonData::SUM,
	...
	CashFlowCommonData(50, "gmwb_income_credit_base_b_aig", "fiacarvm_liab_gmwb_income_credit_base_b_aig",  "gmwb_income_credit_base_b_aig",  CashFlowCommonData::SUM,
	...
	CashFlowCommonData(51, "gmwb_income_credit_base_b_bef_aig", "fiacarvm_liab_gmwb_income_credit_base_b_bef_aig",  "gmwb_income_credit_base_b_bef_aig",  CashFlowCommonData::SUM,
	...
	CashFlowCommonData(52, "gmwb_income_credit_base_e_aig", "fiacarvm_liab_gmwb_income_credit_base_e_aig",  "gmwb_income_credit_base_e_aig",  CashFlowCommonData::SUM,
	...
	CashFlowCommonData(53, "gmwb_income_credit_base_e_bef_aig", "fiacarvm_liab_gmwb_income_credit_base_e_bef_aig",  "gmwb_income_credit_base_e_bef_aig",  CashFlowCommonData::SUM,
	...
	CashFlowCommonData(54, "gmwb_income_credit_e_bef_aig", "fiacarvm_liab_gmwb_income_credit_e_bef_aig",  "gmwb_income_credit_e_bef_aig",  CashFlowCommonData::SUM,
	...
	CashFlowCommonData(55, "gmwb_inf_b_aig", "fiacarvm_liab_gmwb_inf_b_aig",  "gmwb_inf_b_aig",  CashFlowCommonData::SUM,
                     (dPFi)(dPXi)&FIACARVM_LIAB_UDF::fiacarvm_liab_gmwb_inf_b_aig, 'E','Y', '3', 'N', (size_t)&modelOffset->gmwb_inf_b_aig),
	CashFlowCommonData(56, "gmwb_inf_b_bef_aig", "fiacarvm_liab_gmwb_inf_b_bef_aig",  "gmwb_inf_b_bef_aig",  CashFlowCommonData::SUM,
                     (dPFi)(dPXi)&FIACARVM_LIAB_UDF::fiacarvm_liab_gmwb_inf_b_bef_aig, 'E','Y', '3', 'N', (size_t)&modelOffset->gmwb_inf_b_bef_aig),
	CashFlowCommonData(57, "gmwb_inf_e_aig", "fiacarvm_liab_gmwb_inf_e_aig",  "gmwb_inf_e_aig",  CashFlowCommonData::SUM,
                     (dPFi)(dPXi)&FIACARVM_LIAB_UDF::fiacarvm_liab_gmwb_inf_e_aig, 'E','Y', '3', 'N', (size_t)&modelOffset->gmwb_inf_e_aig),
	CashFlowCommonData(58, "gmwb_inf_e_bef_aig", "fiacarvm_liab_gmwb_inf_e_bef_aig",  "gmwb_inf_e_bef_aig",  CashFlowCommonData::SUM,
                     (dPFi)(dPXi)&FIACARVM_LIAB_UDF::fiacarvm_liab_gmwb_inf_e_bef_aig, 'E','Y', '3', 'N', (size_t)&modelOffset->gmwb_inf_e_bef_aig),
	CashFlowCommonData(59, "gmwb_max_annual_wdl_pct_aig", "fiacarvm_liab_gmwb_max_annual_wdl_pct_aig",  "gmwb_max_annual_wdl_pct_aig",  CashFlowCommonData::SUM,
	...
	CashFlowCommonData(60, "gmwb_max_wdl_amt_aig", "fiacarvm_liab_gmwb_max_wdl_amt_aig",  "gmwb_max_wdl_amt_aig",  CashFlowCommonData::SUM,
                     (dPFi)(dPXi)&FIACARVM_LIAB_UDF::fiacarvm_liab_gmwb_max_wdl_amt_aig, 'E','Y', '3', 'N', (size_t)&modelOffset->gmwb_max_wdl_amt_aig),
	CashFlowCommonData(61, "gmwb_min_income_base_e_bef_aig", "fiacarvm_liab_gmwb_min_income_base_e_bef_aig",  "gmwb_min_income_base_e_bef_aig",  CashFlowCommonData::SUM,
	...
	CashFlowCommonData(62, "gmwb_pip_annual_wdl_pct_aig", "fiacarvm_liab_gmwb_pip_annual_wdl_pct_aig",  "gmwb_pip_annual_wdl_pct_aig",  CashFlowCommonData::SUM,
	...
	CashFlowCommonData(63, "guar_min_contract_val", "fiacarvm_liab_guar_min_contract_val",  "guar_min_contract_val",  CashFlowCommonData::SUM,
                     (dPFi)(dPXi)&FIACARVM_LIAB_UDF::fiacarvm_liab_guar_min_contract_val, 'E','N', '3', 'N', (size_t)&modelOffset->guar_min_contract_val),
	CashFlowCommonData(64, "index_term_cap_rate_min_aig", "fiacarvm_liab_index_term_cap_rate_min_aig",  "index_term_cap_rate_min_aig",  CashFlowCommonData::SUM,
	...
	CashFlowCommonData(65, "index_term_par_rate_min_aig", "fiacarvm_liab_index_term_par_rate_min_aig",  "index_term_par_rate_min_aig",  CashFlowCommonData::SUM,
	...
	CashFlowCommonData(66, "index_term_sprd_rate_max_aig", "fiacarvm_liab_index_term_sprd_rate_max_aig",  "index_term_sprd_rate_max_aig",  CashFlowCommonData::SUM,
	...
	CashFlowCommonData(67, "index_term_trigger_rate_min_aig", "fiacarvm_liab_index_term_trigger_rate_min_aig",  "index_term_trigger_rate_min_aig",  CashFlowCommonData::SUM,
	...
	CashFlowCommonData(68, "initialize", "fiacarvm_liab_initialize",  "initialize",  CashFlowCommonData::AVG,
                     (dPFi)(dPXi)&FIACARVM_LIAB_UDF::fiacarvm_liab_initialize, 'E','N', '3', 'N', (size_t)&modelOffset->initialize),
	CashFlowCommonData(69, "min_accum_val_b_aig", "fiacarvm_liab_min_accum_val_b_aig",  "min_accum_val_b_aig",  CashFlowCommonData::SUM,
                     (dPFi)(dPXi)&FIACARVM_LIAB_UDF::fiacarvm_liab_min_accum_val_b_aig, 'E','Y', '3', 'N', (size_t)&modelOffset->min_accum_val_b_aig),
	CashFlowCommonData(70, "min_accum_val_b_bef_aig", "fiacarvm_liab_min_accum_val_b_bef_aig",  "min_accum_val_b_bef_aig",  CashFlowCommonData::SUM,
                     (dPFi)(dPXi)&FIACARVM_LIAB_UDF::fiacarvm_liab_min_accum_val_b_bef_aig, 'E','Y', '3', 'N', (size_t)&modelOffset->min_accum_val_b_bef_aig),
	CashFlowCommonData(71, "min_accum_val_e_aig", "fiacarvm_liab_min_accum_val_e_aig",  "min_accum_val_e_aig",  CashFlowCommonData::SUM,
                     (dPFi)(dPXi)&FIACARVM_LIAB_UDF::fiacarvm_liab_min_accum_val_e_aig, 'E','Y', '3', 'N', (size_t)&modelOffset->min_accum_val_e_aig),
	CashFlowCommonData(72, "min_accum_val_e_bef_aig", "fiacarvm_liab_min_accum_val_e_bef_aig",  "min_accum_val_e_bef_aig",  CashFlowCommonData::SUM,
                     (dPFi)(dPXi)&FIACARVM_LIAB_UDF::fiacarvm_liab_min_accum_val_e_bef_aig, 'E','Y', '3', 'N', (size_t)&modelOffset->min_accum_val_e_bef_aig),
	CashFlowCommonData(73, "min_wdl_val_alt_b_aig", "fiacarvm_liab_min_wdl_val_alt_b_aig",  "min_wdl_val_alt_b_aig",  CashFlowCommonData::SUM,
                     (dPFi)(dPXi)&FIACARVM_LIAB_UDF::fiacarvm_liab_min_wdl_val_alt_b_aig, 'E','Y', '3', 'N', (size_t)&modelOffset->min_wdl_val_alt_b_aig),
	CashFlowCommonData(74, "min_wdl_val_alt_base_b_aig", "fiacarvm_liab_min_wdl_val_alt_base_b_aig",  "min_wdl_val_alt_base_b_aig",  CashFlowCommonData::SUM,
	...
	CashFlowCommonData(75, "min_wdl_val_alt_base_e_aig", "fiacarvm_liab_min_wdl_val_alt_base_e_aig",  "min_wdl_val_alt_base_e_aig",  CashFlowCommonData::SUM,
	...
	CashFlowCommonData(76, "min_wdl_val_alt_base_e_bef_aig", "fiacarvm_liab_min_wdl_val_alt_base_e_bef_aig",  "min_wdl_val_alt_base_e_bef_aig",  CashFlowCommonData::SUM,
	...
	CashFlowCommonData(77, "min_wdl_val_alt_e_aig", "fiacarvm_liab_min_wdl_val_alt_e_aig",  "min_wdl_val_alt_e_aig",  CashFlowCommonData::SUM,
                     (dPFi)(dPXi)&FIACARVM_LIAB_UDF::fiacarvm_liab_min_wdl_val_alt_e_aig, 'E','Y', '3', 'N', (size_t)&modelOffset->min_wdl_val_alt_e_aig),
	CashFlowCommonData(78, "min_wdl_val_alt_e_bef_aig", "fiacarvm_liab_min_wdl_val_alt_e_bef_aig",  "min_wdl_val_alt_e_bef_aig",  CashFlowCommonData::SUM,
                     (dPFi)(dPXi)&FIACARVM_LIAB_UDF::fiacarvm_liab_min_wdl_val_alt_e_bef_aig, 'E','Y', '3', 'N', (size_t)&modelOffset->min_wdl_val_alt_e_bef_aig),
	CashFlowCommonData(79, "min_wdl_val_b_aig", "fiacarvm_liab_min_wdl_val_b_aig",  "min_wdl_val_b_aig",  CashFlowCommonData::SUM,
                     (dPFi)(dPXi)&FIACARVM_LIAB_UDF::fiacarvm_liab_min_wdl_val_b_aig, 'E','Y', '3', 'N', (size_t)&modelOffset->min_wdl_val_b_aig),
	CashFlowCommonData(80, "min_wdl_val_b_bef_aig", "fiacarvm_liab_min_wdl_val_b_bef_aig",  "min_wdl_val_b_bef_aig",  CashFlowCommonData::SUM,
                     (dPFi)(dPXi)&FIACARVM_LIAB_UDF::fiacarvm_liab_min_wdl_val_b_bef_aig, 'E','Y', '3', 'N', (size_t)&modelOffset->min_wdl_val_b_bef_aig),
	CashFlowCommonData(81, "min_wdl_val_e_aig", "fiacarvm_liab_min_wdl_val_e_aig",  "min_wdl_val_e_aig",  CashFlowCommonData::SUM,
                     (dPFi)(dPXi)&FIACARVM_LIAB_UDF::fiacarvm_liab_min_wdl_val_e_aig, 'E','Y', '3', 'N', (size_t)&modelOffset->min_wdl_val_e_aig),
	CashFlowCommonData(82, "min_wdl_val_e_bef_aig", "fiacarvm_liab_min_wdl_val_e_bef_aig",  "min_wdl_val_e_bef_aig",  CashFlowCommonData::SUM,
                     (dPFi)(dPXi)&FIACARVM_LIAB_UDF::fiacarvm_liab_min_wdl_val_e_bef_aig, 'E','Y', '3', 'N', (size_t)&modelOffset->min_wdl_val_e_bef_aig),
	CashFlowCommonData(83, "min_wdl_val_final_b_aig", "fiacarvm_liab_min_wdl_val_final_b_aig",  "min_wdl_val_final_b_aig",  CashFlowCommonData::SUM,
                     (dPFi)(dPXi)&FIACARVM_LIAB_UDF::fiacarvm_liab_min_wdl_val_final_b_aig, 'B','Y', '3', 'N', (size_t)&modelOffset->min_wdl_val_final_b_aig),
	CashFlowCommonData(84, "min_wdl_val_final_e_aig", "fiacarvm_liab_min_wdl_val_final_e_aig",  "min_wdl_val_final_e_aig",  CashFlowCommonData::SUM,
                     (dPFi)(dPXi)&FIACARVM_LIAB_UDF::fiacarvm_liab_min_wdl_val_final_e_aig, 'E','Y', '3', 'N', (size_t)&modelOffset->min_wdl_val_final_e_aig),
	CashFlowCommonData(85, "min_wdl_val_final_e_bef_aig", "fiacarvm_liab_min_wdl_val_final_e_bef_aig",  "min_wdl_val_final_e_bef_aig",  CashFlowCommonData::SUM,
	...
	CashFlowCommonData(86, "nh_benefits_pv", "fiacarvm_liab_nh_benefits_pv",  "nh_benefits_pv",  CashFlowCommonData::SUM,
                     (dPFi)(dPXi)&FIACARVM_LIAB_UDF::fiacarvm_liab_nh_benefits_pv, 'E','N', '3', 'N', (size_t)&modelOffset->nh_benefits_pv),
	CashFlowCommonData(87, "nh_incid_rate", "fiacarvm_liab_nh_incid_rate",  "nh_incid_rate",  CashFlowCommonData::AVG,
                     (dPFi)(dPXi)&FIACARVM_LIAB_UDF::fiacarvm_liab_nh_incid_rate, 'E','Y', '3', 'N', (size_t)&modelOffset->nh_incid_rate),
	CashFlowCommonData(88, "pfwd_entitlement_b_aig", "fiacarvm_liab_pfwd_entitlement_b_aig",  "pfwd_entitlement_b_aig",  CashFlowCommonData::SUM,
                     (dPFi)(dPXi)&FIACARVM_LIAB_UDF::fiacarvm_liab_pfwd_entitlement_b_aig, 'E','Y', '3', 'N', (size_t)&modelOffset->pfwd_entitlement_b_aig),
	CashFlowCommonData(89, "pfwd_entitlement_b_bef_aig", "fiacarvm_liab_pfwd_entitlement_b_bef_aig",  "pfwd_entitlement_b_bef_aig",  CashFlowCommonData::SUM,
	...
	CashFlowCommonData(90, "pfwd_entitlement_e_aig", "fiacarvm_liab_pfwd_entitlement_e_aig",  "pfwd_entitlement_e_aig",  CashFlowCommonData::SUM,
                     (dPFi)(dPXi)&FIACARVM_LIAB_UDF::fiacarvm_liab_pfwd_entitlement_e_aig, 'E','Y', '3', 'N', (size_t)&modelOffset->pfwd_entitlement_e_aig),
	CashFlowCommonData(91, "pfwd_entitlement_e_bef_aig", "fiacarvm_liab_pfwd_entitlement_e_bef_aig",  "pfwd_entitlement_e_bef_aig",  CashFlowCommonData::SUM,
	...
	CashFlowCommonData(92, "pfwd_pct_aig", "fiacarvm_liab_pfwd_pct_aig",  "pfwd_pct_aig",  CashFlowCommonData::SUM,
                     (dPFi)(dPXi)&FIACARVM_LIAB_UDF::fiacarvm_liab_pfwd_pct_aig, 'E','Y', '3', 'N', (size_t)&modelOffset->pfwd_pct_aig),
	CashFlowCommonData(93, "pfwd_surr_aig", "fiacarvm_liab_pfwd_surr_aig",  "pfwd_surr_aig",  CashFlowCommonData::SUM,
                     (dPFi)(dPXi)&FIACARVM_LIAB_UDF::fiacarvm_liab_pfwd_surr_aig, 'E','Y', '3', 'N', (size_t)&modelOffset->pfwd_surr_aig),
	CashFlowCommonData(94, "pfwd_surr_cumul_aig", "fiacarvm_liab_pfwd_surr_cumul_aig",  "pfwd_surr_cumul_aig",  CashFlowCommonData::SUM,
                     (dPFi)(dPXi)&FIACARVM_LIAB_UDF::fiacarvm_liab_pfwd_surr_cumul_aig, 'E','Y', '3', 'N', (size_t)&modelOffset->pfwd_surr_cumul_aig),
	CashFlowCommonData(95, "pfwd_surr_pv", "fiacarvm_liab_pfwd_surr_pv",  "pfwd_surr_pv",  CashFlowCommonData::SUM,
                     (dPFi)(dPXi)&FIACARVM_LIAB_UDF::fiacarvm_liab_pfwd_surr_pv, 'E','N', '3', 'N', (size_t)&modelOffset->pfwd_surr_pv),
	CashFlowCommonData(96, "pol_mth_aig", "fiacarvm_liab_pol_mth_aig",  "pol_mth_aig",  CashFlowCommonData::SUM,
                     (dPFi)(dPXi)&FIACARVM_LIAB_UDF::fiacarvm_liab_pol_mth_aig, 'E','Y', '3', 'N', (size_t)&modelOffset->pol_mth_aig),
	CashFlowCommonData(97, "pol_yr", "fiacarvm_liab_pol_yr",  "pol_yr",  CashFlowCommonData::AVG,
                     (dPFi)(dPXi)&FIACARVM_LIAB_UDF::fiacarvm_liab_pol_yr, 'B','N', '3', 'N', (size_t)&modelOffset->pol_yr),
	CashFlowCommonData(98, "policies_female_experience_aig", "fiacarvm_liab_policies_female_experience_aig",  "policies_female_experience_aig",  CashFlowCommonData::AVG,
	...
	CashFlowCommonData(99, "policies_joint_experience_aig", "fiacarvm_liab_policies_joint_experience_aig",  "policies_joint_experience_aig",  CashFlowCommonData::AVG,
	...
	CashFlowCommonData(100, "policies_last_survivor_experience_aig", "fiacarvm_liab_policies_last_survivor_experience_aig",  "policies_last_survivor_experience_aig",  CashFlowCommonData::AVG,
	...
	CashFlowCommonData(101, "policies_male_experience_aig", "fiacarvm_liab_policies_male_experience_aig",  "policies_male_experience_aig",  CashFlowCommonData::AVG,
	...
	CashFlowCommonData(102, "prem_bonus_recapture_aig", "fiacarvm_liab_prem_bonus_recapture_aig",  "prem_bonus_recapture_aig",  CashFlowCommonData::SUM,
                     (dPFi)(dPXi)&FIACARVM_LIAB_UDF::fiacarvm_liab_prem_bonus_recapture_aig, 'E','Y', '3', 'N', (size_t)&modelOffset->prem_bonus_recapture_aig),
	CashFlowCommonData(103, "res_integrated", "fiacarvm_liab_res_integrated",  "res_integrated",  CashFlowCommonData::SUM,
                     (dPFi)(dPXi)&FIACARVM_LIAB_UDF::fiacarvm_liab_res_integrated, 'E','N', '3', 'N', (size_t)&modelOffset->res_integrated),
	CashFlowCommonData(104, "res_integrated_annuitzn", "fiacarvm_liab_res_integrated_annuitzn",  "res_integrated_annuitzn",  CashFlowCommonData::SUM,
                     (dPFi)(dPXi)&FIACARVM_LIAB_UDF::fiacarvm_liab_res_integrated_annuitzn, 'E','N', '3', 'N', (size_t)&modelOffset->res_integrated_annuitzn),
	CashFlowCommonData(105, "res_integrated_cash_val", "fiacarvm_liab_res_integrated_cash_val",  "res_integrated_cash_val",  CashFlowCommonData::SUM,
                     (dPFi)(dPXi)&FIACARVM_LIAB_UDF::fiacarvm_liab_res_integrated_cash_val, 'E','N', '3', 'N', (size_t)&modelOffset->res_integrated_cash_val),
	CashFlowCommonData(106, "startup", "fiacarvm_liab_startup",  "startup",  CashFlowCommonData::SUM,
                     (dPFi)(dPXi)&FIACARVM_LIAB_UDF::virtual_startup, 'E','N', '3', 'N', (size_t)&modelOffset->startup),
	CashFlowCommonData(107, "surr_chg_b_aig", "fiacarvm_liab_surr_chg_b_aig",  "surr_chg_b_aig",  CashFlowCommonData::SUM,
                     (dPFi)(dPXi)&FIACARVM_LIAB_UDF::fiacarvm_liab_surr_chg_b_aig, 'E','Y', '3', 'N', (size_t)&modelOffset->surr_chg_b_aig),
	CashFlowCommonData(108, "surr_chg_b_bef_aig", "fiacarvm_liab_surr_chg_b_bef_aig",  "surr_chg_b_bef_aig",  CashFlowCommonData::SUM,
                     (dPFi)(dPXi)&FIACARVM_LIAB_UDF::fiacarvm_liab_surr_chg_b_bef_aig, 'E','Y', '3', 'N', (size_t)&modelOffset->surr_chg_b_bef_aig),
	CashFlowCommonData(109, "surr_chg_e_aig", "fiacarvm_liab_surr_chg_e_aig",  "surr_chg_e_aig",  CashFlowCommonData::SUM,
                     (dPFi)(dPXi)&FIACARVM_LIAB_UDF::fiacarvm_liab_surr_chg_e_aig, 'E','Y', '3', 'N', (size_t)&modelOffset->surr_chg_e_aig),
	CashFlowCommonData(110, "surr_chg_e_bef_aig", "fiacarvm_liab_surr_chg_e_bef_aig",  "surr_chg_e_bef_aig",  CashFlowCommonData::SUM,
                     (dPFi)(dPXi)&FIACARVM_LIAB_UDF::fiacarvm_liab_surr_chg_e_bef_aig, 'E','N', '3', 'N', (size_t)&modelOffset->surr_chg_e_bef_aig),
	CashFlowCommonData(111, "surr_chg_pct", "fiacarvm_liab_surr_chg_pct",  "surr_chg_pct",  CashFlowCommonData::SUM,
                     (dPFi)(dPXi)&FIACARVM_LIAB_UDF::fiacarvm_liab_surr_chg_pct, 'E','N', '3', 'N', (size_t)&modelOffset->surr_chg_pct),
	CashFlowCommonData(112, "surv", "fiacarvm_liab_surv",  "surv",  CashFlowCommonData::AVG,
...
TableMgr<VariantTable> FIACARVM_LIAB::mgr_;
	...
	Descriptor(23, Attribute::DOUBLE,	"dth_benefits_weight_aig", Descriptor::NOT_INDEXED, (size_t)&modelOffset->dth_benefits_weight_aig,
				Descriptor::NOT_SHARED, false, false, (size_t)0, 0, Feature()),
	Descriptor(24, Attribute::STR_ENUM,	"gender", -1, (size_t)&modelOffset->gender,
				Descriptor::NOT_SHARED, false, false, (size_t)0, &genderEnumList, Feature(true)),
	Descriptor(25, Attribute::DOUBLE,	"gmwb_ann_benefits_weight_aig", Descriptor::NOT_INDEXED, (size_t)&modelOffset->gmwb_ann_benefits_weight_aig,
				Descriptor::NOT_SHARED, false, false, (size_t)0, 0, Feature()),
	Descriptor(26, Attribute::INT,	"gmwb_exercise_point", -1, (size_t)&modelOffset->gmwb_exercise_point,
				Descriptor::NOT_SHARED, false, false, (size_t)0, 0, Feature()),
	Descriptor(27, Attribute::STR_ENUM,	"gmwb_flex_defn_aig", -1, (size_t)&modelOffset->gmwb_flex_defn_aig,
				Descriptor::NOT_SHARED, false, false, (size_t)0, &gmwb_flex_defn_aigEnumList, Feature(true)),
	Descriptor(28, Attribute::STR_ENUM,	"gmwb_flex_mawp_adj_method_aig", -1, (size_t)&modelOffset->gmwb_flex_mawp_adj_method_aig,
				Descriptor::NOT_SHARED, false, false, (size_t)0, &gmwb_flex_mawp_adj_method_aigEnumList, Feature(true)),
	Descriptor(29, Attribute::DOUBLE,	"gmwb_mort_base", Descriptor::NOT_INDEXED, (size_t)&modelOffset->gmwb_mort_base,
				Descriptor::NOT_SHARED, false, false, (size_t)0, 0, Feature()),
	Descriptor(30, Attribute::STRING,	"gmwb_mort_base_tbl_id", -1, (size_t)&modelOffset->gmwb_mort_base_tbl_id,
				Descriptor::NOT_SHARED, false, false, (size_t)0, 0, Feature()),
	Descriptor(31, Attribute::STRING,	"gmwb_mort_base_tbl_style", -1, (size_t)&modelOffset->gmwb_mort_base_tbl_style,
				Descriptor::NOT_SHARED, false, false, (size_t)0, 0, Feature()),
	Descriptor(32, Attribute::DOUBLE,	"gmwb_mort_improve_pct_aig", Descriptor::NOT_INDEXED, (size_t)&modelOffset->gmwb_mort_improve_pct_aig,
				Descriptor::NOT_SHARED, false, false, (size_t)0, 0, Feature()),
	Descriptor(33, Attribute::INT,	"gmwb_wait_period_aig", -1, (size_t)&modelOffset->gmwb_wait_period_aig,
				Descriptor::NOT_SHARED, false, false, (size_t)0, 0, Feature()),
	Descriptor(34, Attribute::INT,	"gmwb_wdl_proj_yr_aig", -1, (size_t)&modelOffset->gmwb_wdl_proj_yr_aig,
				Descriptor::NOT_SHARED, false, false, (size_t)0, 0, Feature()),
	Descriptor(35, Attribute::STR_ENUM,	"include_nh_defn", -1, (size_t)&modelOffset->include_nh_defn,
				Descriptor::NOT_SHARED, false, false, (size_t)0, &include_nh_defnEnumList, Feature(true)),
	Descriptor(36, Attribute::INT,	"issue_age_aig", -1, (size_t)&modelOffset->issue_age_aig,
				Descriptor::NOT_SHARED, false, false, (size_t)0, 0, Feature()),
	Descriptor(37, Attribute::DOUBLE,	"min_wdl_val_growth_pct_aig", Descriptor::NOT_INDEXED, (size_t)&modelOffset->min_wdl_val_growth_pct_aig,
				Descriptor::NOT_SHARED, false, false, (size_t)0, 0, Feature()),
	Descriptor(38, Attribute::STRING,	"model_name_gen2", -1, (size_t)&modelOffset->model_name_gen2,
				Descriptor::NOT_SHARED, false, false, (size_t)0, 0, Feature()),
	Descriptor(39, Attribute::INT,	"mort_attained_age", -1, (size_t)&modelOffset->mort_attained_age,
				Descriptor::NOT_SHARED, false, false, (size_t)0, 0, Feature()),
	Descriptor(40, Attribute::STR_ENUM,	"mort_calc_basis_joint_aig", -1, (size_t)&modelOffset->mort_calc_basis_joint_aig,
				Descriptor::NOT_SHARED, false, false, (size_t)0, &mort_calc_basis_joint_aigEnumList, Feature(true)),
	Descriptor(41, Attribute::STR_ENUM,	"mort_gender", -1, (size_t)&modelOffset->mort_gender,
				Descriptor::NOT_SHARED, false, false, (size_t)0, &mort_genderEnumList, Feature(true)),
	Descriptor(42, Attribute::STRING,	"mort_improve_base_date_aig", -1, (size_t)&modelOffset->mort_improve_base_date_aig,
				Descriptor::NOT_SHARED, false, false, (size_t)0, 0, Feature()),
	Descriptor(43, Attribute::INT,	"mort_issue_age", -1, (size_t)&modelOffset->mort_issue_age,
				Descriptor::NOT_SHARED, false, false, (size_t)0, 0, Feature()),
	Descriptor(44, Attribute::INT,	"mort_pol_yr", -1, (size_t)&modelOffset->mort_pol_yr,
				Descriptor::NOT_SHARED, false, false, (size_t)0, 0, Feature()),
	Descriptor(45, Attribute::STR_ENUM,	"mva_defn_aig", -1, (size_t)&modelOffset->mva_defn_aig,
				Descriptor::NOT_SHARED, false, false, (size_t)0, &mva_defn_aigEnumList, Feature(true)),
	Descriptor(46, Attribute::DOUBLE,	"nh_benefits_weight_aig", Descriptor::NOT_INDEXED, (size_t)&modelOffset->nh_benefits_weight_aig,
				Descriptor::NOT_SHARED, false, false, (size_t)0, 0, Feature()),
	Descriptor(47, Attribute::DOUBLE,	"nh_incid_base", Descriptor::NOT_INDEXED, (size_t)&modelOffset->nh_incid_base,
				Descriptor::NOT_SHARED, false, false, (size_t)0, 0, Feature()),
	Descriptor(48, Attribute::STRING,	"nh_incid_base_tbl_id_aig", -1, (size_t)&modelOffset->nh_incid_base_tbl_id_aig,
				Descriptor::NOT_SHARED, false, false, (size_t)0, 0, Feature()),
	Descriptor(49, Attribute::STR_ENUM,	"pfwd_model_switch_aig", -1, (size_t)&modelOffset->pfwd_model_switch_aig,
				Descriptor::NOT_SHARED, false, false, (size_t)0, &pfwd_model_switch_aigEnumList, Feature(true)),
	Descriptor(50, Attribute::DOUBLE,	"pfwd_surr_weight_aig", Descriptor::NOT_INDEXED, (size_t)&modelOffset->pfwd_surr_weight_aig,
				Descriptor::NOT_SHARED, false, false, (size_t)0, 0, Feature()),
	Descriptor(51, Attribute::STRING,	"plan_code", -1, (size_t)&modelOffset->plan_code,
				Descriptor::NOT_SHARED, false, false, (size_t)0, 0, Feature()),
	Descriptor(52, Attribute::DOUBLE,	"prem_bonus_recapture_pct_carvm_aig", Descriptor::NOT_INDEXED, (size_t)&modelOffset->prem_bonus_recapture_pct_carvm_aig,
				Descriptor::NOT_SHARED, false, false, (size_t)0, 0, Feature()),
	Descriptor(53, Attribute::INT,	"pv_max_period", -1, (size_t)&modelOffset->pv_max_period,
				Descriptor::NOT_SHARED, false, false, (size_t)0, 0, Feature()),
	Descriptor(54, Attribute::STR_ENUM,	"valn_carvm_defn", -1, (size_t)&modelOffset->valn_carvm_defn,
				Descriptor::NOT_SHARED, false, false, (size_t)0, &valn_carvm_defnEnumList, Feature(true)),
	Descriptor(55, Attribute::STR_ENUM,	"valn_cash_settle_defn", -1, (size_t)&modelOffset->valn_cash_settle_defn,
				Descriptor::NOT_SHARED, false, false, (size_t)0, &valn_cash_settle_defnEnumList, Feature(true)),
	Descriptor(56, Attribute::INT,	"valn_guar_dur", -1, (size_t)&modelOffset->valn_guar_dur,
				Descriptor::NOT_SHARED, false, false, (size_t)0, 0, Feature()),
	Descriptor(57, Attribute::STR_ENUM,	"valn_int_guar_defn", -1, (size_t)&modelOffset->valn_int_guar_defn,
				Descriptor::NOT_SHARED, false, false, (size_t)0, &valn_int_guar_defnEnumList, Feature(true)),
	Descriptor(58, Attribute::INT,	"valn_issue_yr", -1, (size_t)&modelOffset->valn_issue_yr,
				Descriptor::NOT_SHARED, false, false, (size_t)0, 0, Feature()),
	Descriptor(59, Attribute::STR_ENUM,	"valn_plan_type", -1, (size_t)&modelOffset->valn_plan_type,
				Descriptor::NOT_SHARED, false, false, (size_t)0, &valn_plan_typeEnumList, Feature(true)),
	Descriptor(60, Attribute::INT,	"msnumelement", -1, (size_t)&modelOffset->msnumelement,
				Descriptor::NOT_SHARED, false, false, (size_t)0, 0, Feature()),
	Descriptor(61, Attribute::SCALAR_INT,	"carvm_annuitzn_test_num", -1, (size_t)&modelOffset->carvm_annuitzn_test_num,
				Descriptor::NOT_SHARED, false, false, (size_t)0, 0, Feature((iF)&FIACARVM_LIAB_UDF::fiacarvm_liab_carvm_annuitzn_test_num)),
	Descriptor(62, Attribute::SCALAR_STRING,	"carvm_cont_defn_aig", -1, (size_t)&modelOffset->carvm_cont_defn_aig,
				Descriptor::NOT_SHARED, false, false, (size_t)0, 0, Feature((sF)&FIACARVM_LIAB_UDF::fiacarvm_liab_carvm_cont_defn_aig)),
	Descriptor(63, Attribute::SCALAR_STRING,	"glb_withdrls_have_begun_aig", -1, (size_t)&modelOffset->glb_withdrls_have_begun_aig,
				Descriptor::NOT_SHARED, false, false, (size_t)0, 0, Feature((sF)&FIACARVM_LIAB_UDF::fiacarvm_liab_glb_withdrls_have_begun_aig)),
	Descriptor(64, Attribute::SCALAR_INT,	"int_guar_dur", -1, (size_t)&modelOffset->int_guar_dur,
				Descriptor::NOT_SHARED, false, false, (size_t)0, 0, Feature((iF)&FIACARVM_LIAB_UDF::fiacarvm_liab_int_guar_dur)),
	Descriptor(65, Attribute::SCALAR_INT,	"issue_date", -1, (size_t)&modelOffset->issue_date,
				Descriptor::NOT_SHARED, false, false, (size_t)0, 0, Feature((iF)&FIACARVM_LIAB_UDF::fiacarvm_liab_issue_date)),
	Descriptor(66, Attribute::SCALAR_INT,	"max_calc_period", -1, (size_t)&modelOffset->max_calc_period,
				Descriptor::NOT_SHARED, false, false, (size_t)0, 0, Feature((iF)&FIACARVM_LIAB_UDF::fiacarvm_liab_max_calc_period)),
	Descriptor(67, Attribute::SCALAR_DOUBLE,	"mths_in_first_year", -1, (size_t)&modelOffset->mths_in_first_year,
				Descriptor::NOT_SHARED, false, false, (size_t)0, 0, Feature((dF)&FIACARVM_LIAB_UDF::fiacarvm_liab_mths_in_first_year)),
	Descriptor(68, Attribute::SCALAR_STRING,	"pfwd_model", -1, (size_t)&modelOffset->pfwd_model,
				Descriptor::NOT_SHARED, false, false, (size_t)0, 0, Feature((sF)&FIACARVM_LIAB_UDF::fiacarvm_liab_pfwd_model)),
	Descriptor(69, Attribute::SCALAR_DOUBLE,	"prem_cumul", -1, (size_t)&modelOffset->prem_cumul,
	...
	nullptr};
	const size_t FIACARVM_LIAB::sDescriptorCount = 70;
...
FIACARVM_LIAB::FIACARVM_LIAB(const xstring &modelClassName,
		...
		const char *name, ModelClass* arrayPersistentObj) : ModelClass(112, FIACARVM_LIAB::descriptorTable, arrayPersistentObj), Variable(*this)
  , sm_bond_is(0)
  , sm_bond_pv(0)
  , sm_bond_ym(0)
  , sm_mtg_is(0)
...
#pragma warning(pop)
   ...
   mMOCD = descriptorTable;
	...
	for (int cf_no = 1; cf_no <= 112; cf_no++)
#ifdef CF_MEMORY
		setPtr_col(cf_no, 0);
#else
...
BitArray FIACARVM_LIAB::dataVariables(70);
