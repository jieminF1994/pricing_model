#ifndef __MTG_ASSET_H_
#define __MTG_ASSET_H_
...
class MTG_ASSET_persistent_object;
class MTG_ASSET : public ModelClass {
...
public :
	...
	size_t sizeofThis() const { return sizeof(MTG_ASSET); }
...
adj_addn_init = 0.0;
 ...
 // Column Definition Begins
 	...
 	ColumnAccessor < mCFStaticData_0 > cap_gain_adj_foreclosure_prin_pmt;
 	ColumnAccessor < mCFStaticData_0 > cap_gain_adj_restructure_prin_pmt;
 	...
 	ColumnAccessor < mCFStaticData_0 > cost_basis_aft_prepmt;
 	ColumnAccessor < mCFStaticData_0 > cost_basis_bef_prepmt;
 	...
 	ColumnAccessor < mCFStaticData_0 > foreclosure_pct;
 	ColumnAccessor < mCFStaticData_0 > foreclosure_prin_net_write_down;
 	ColumnAccessor < mCFStaticData_0 > foreclosure_rate;
 	...
 	ColumnAccessor < mCFStaticData_0 > imr_realzd_cap_gain_rml;
 	ColumnAccessor < mCFStaticData_0 > imr_realzd_cap_gain_rml_from_sale;
 	...
 	ColumnAccessor < mCFStaticData_0 > intex_accr_int_adj;
 	ColumnAccessor < mCFStaticData_0 > intex_pct_remaining;
 	ColumnAccessor < mCFStaticData_0 > intex_tgt;
 	...
 	ColumnAccessor < mCFStaticData_0 > mths_bef_maturity;
 	...
 	ColumnAccessor < mCFStaticData_0 > realzd_cap_gain_prepmt;
 	ColumnAccessor < mCFStaticData_0 > realzd_cap_gain_sale;
 	ColumnAccessor < mCFStaticData_0 > realzd_cap_loss_dflt;
 	ColumnAccessor < mCFStaticData_0 > realzd_cap_loss_foreclosure;
 	ColumnAccessor < mCFStaticData_0 > realzd_cap_loss_restructure;
 	ColumnAccessor < mCFStaticData_0 > refinance_accr_int;
 	ColumnAccessor < mCFStaticData_0 > refinance_bk_val;
 	ColumnAccessor < mCFStaticData_0 > refinance_cost_basis;
 	ColumnAccessor < mCFStaticData_0 > refinance_pct;
 	ColumnAccessor < mCFStaticData_0 > refinance_prin;
 	ColumnAccessor < mCFStaticData_0 > refinance_rate;
 	ColumnAccessor < mCFStaticData_0 > restructure_accr_int_net_write_down;
 	...
 	ColumnAccessor < mCFStaticData_0 > restructure_pct;
 	ColumnAccessor < mCFStaticData_0 > restructure_prin_net_write_down;
 	ColumnAccessor < mCFStaticData_0 > restructure_rate;
 	...
 	ColumnAccessor < mCFStaticData_0 > unrealzd_cap_loss_from_dflt;
 	ColumnAccessor < mCFStaticData_0 > weighted_avg_life;
 	ColumnAccessor < mCFStaticData_0 > write_down;
...
//Column Definition END@2
 ...
 // Temporary Table...
MTG_CF_ASSET *sm_mtg_cf;
MTG_ASSET *sm_bond_is;
MTG_ASSET *sm_bond_pv;
MTG_ASSET *sm_bond_ym;
MTG_ASSET *sm_mtg_is;
MTG_ASSET *sm_mtg_pv;
MTG_ASSET *sm_mtg_ym;
...
#endif	MICROSOFT
	#define DESCRIPTOR_TABLE MTG_ASSET::descriptor_0
#ifdef MICROSOFT
#pragma warning(pop)
#endif	MICROSOFT
	Attribute::ProxyReadOnly <StringEnum, DESCRIPTOR_TABLE > adco_adj_rate_defn;
  inline xstring	Get_adco_adj_rate_defn() {
		return adco_adj_rate_defn; }
	Attribute::ProxyReadOnly <xstring, DESCRIPTOR_TABLE > adco_category_id;
  inline xstring	Get_adco_category_id() {
		return adco_category_id; }
	Attribute::ProxyReadOnly <xstring, DESCRIPTOR_TABLE > adco_collateral_defn;
  inline xstring	Get_adco_collateral_defn() {
		return adco_collateral_defn; }
	Attribute::ProxyReadOnly <StringEnum, DESCRIPTOR_TABLE > adco_subprime_defn;
  inline xstring	Get_adco_subprime_defn() {
		return adco_subprime_defn; }
  ...
  inline xstring	Get_amortzd_cost_period_defn() {
	...
	Attribute::ProxyReadOnly <int, DESCRIPTOR_TABLE > amortzn_start_cy_mp;
  inline int	Get_amortzn_start_cy_mp() {
		return amortzn_start_cy_mp; }
  ...
  inline double	Get_avr_obj_pct_mp() {
	...
	Attribute::ProxyReadOnly <xstring, DESCRIPTOR_TABLE > balloon_date_mp;
  inline xstring	Get_balloon_date_mp() {
		return balloon_date_mp; }
	Attribute::ProxyReadOnly <StringEnum, DESCRIPTOR_TABLE > balloon_defn_mp;
  inline xstring	Get_balloon_defn_mp() {
		return balloon_defn_mp; }
	Attribute::ProxyReadOnly <double, DESCRIPTOR_TABLE > balloon_prin_pmt_pct;
  inline double	Get_balloon_prin_pmt_pct() {
		return balloon_prin_pmt_pct; }
  ...
  inline xstring	Get_data_validation_defn() {
	...
	Attribute::ProxyReadOnly <StringEnum, DESCRIPTOR_TABLE > dflt_rate_bef_maturity_defn;
  inline xstring	Get_dflt_rate_bef_maturity_defn() {
		return dflt_rate_bef_maturity_defn; }
	Attribute::ProxyReadOnly <double, DESCRIPTOR_TABLE > dflt_rate_scen_mult;
  inline double	Get_dflt_rate_scen_mult() {
		return dflt_rate_scen_mult; }
  ...
  inline void Set_dur_wtd_sprd_adj_aig(const double &v) {
	...
	Attribute::ProxyReadOnly <double, DESCRIPTOR_TABLE > dur_wtd_sprd_adj_aig_mp;
  inline double	Get_dur_wtd_sprd_adj_aig_mp() {
		return dur_wtd_sprd_adj_aig_mp; }
  ...
  inline xstring	Get_fast_stat_calc_aig() {
	...
	Attribute::ProxyReadOnly <double, DESCRIPTOR_TABLE > foreclosure_rate_mult_bef_maturity;
  inline double	Get_foreclosure_rate_mult_bef_maturity() {
		return foreclosure_rate_mult_bef_maturity; }
	Attribute::ProxyReadOnly <double, DESCRIPTOR_TABLE > foreclosure_rate_mult_since_issue;
  inline double	Get_foreclosure_rate_mult_since_issue() {
		return foreclosure_rate_mult_since_issue; }
	Attribute::ProxyReadOnly <double, DESCRIPTOR_TABLE > foreclosure_rate_pct;
  inline double	Get_foreclosure_rate_pct() {
		return foreclosure_rate_pct; }
	Attribute::ProxyReadOnly <double, DESCRIPTOR_TABLE > foreclosure_rate_scen_mult;
  inline double	Get_foreclosure_rate_scen_mult() {
		return foreclosure_rate_scen_mult; }
	Attribute::ProxyReadOnly <double, DESCRIPTOR_TABLE > foreclosure_write_down_pct;
  inline double	Get_foreclosure_write_down_pct() {
		return foreclosure_write_down_pct; }
  ...
  inline int	Get_mkt_val_calc_freq_yrs() {
	...
	Attribute::Proxy <StringEnum, DESCRIPTOR_TABLE > mkt_val_defn;
  inline xstring	Get_mkt_val_defn() {
		return mkt_val_defn; }
  inline void Set_mkt_val_defn(const xstring &v) {
		mkt_val_defn.setValue(v); }
	Attribute::Proxy <double, DESCRIPTOR_TABLE > nonfinancial_int_rate_diff;
  inline double	Get_nonfinancial_int_rate_diff() {
		return nonfinancial_int_rate_diff; }
  inline void Set_nonfinancial_int_rate_diff(const double &v) {
		nonfinancial_int_rate_diff.setValue(v); }
  ...
  inline xstring	Get_pmt_mode_mp() {
		return pmt_mode_mp; }
	Attribute::Proxy <StringEnum, DESCRIPTOR_TABLE > pmt_rate_defn_purch;
  inline xstring	Get_pmt_rate_defn_purch() {
		return pmt_rate_defn_purch; }
  inline void Set_pmt_rate_defn_purch(const xstring &v) {
		pmt_rate_defn_purch.setValue(v); }
  ...
  inline void Set_portfolio_sprd_adj_aig(const double &v) {
	...
	Attribute::ProxyReadOnly <double, DESCRIPTOR_TABLE > portfolio_sprd_adj_aig_mp;
  inline double	Get_portfolio_sprd_adj_aig_mp() {
		return portfolio_sprd_adj_aig_mp; }
	Attribute::ProxyReadOnly <StringEnum, DESCRIPTOR_TABLE > prepmt_defn;
  inline xstring	Get_prepmt_defn() {
		return prepmt_defn; }
	Attribute::ProxyReadOnly <double, DESCRIPTOR_TABLE > prepmt_exercise_pct_input;
  inline double	Get_prepmt_exercise_pct_input() {
		return prepmt_exercise_pct_input; }
	Attribute::ProxyReadOnly <StringEnum, DESCRIPTOR_TABLE > prepmt_int_diff_defn;
  inline xstring	Get_prepmt_int_diff_defn() {
		return prepmt_int_diff_defn; }
	Attribute::ProxyReadOnly <StringEnum, DESCRIPTOR_TABLE > prepmt_model_defn;
  inline xstring	Get_prepmt_model_defn() {
		return prepmt_model_defn; }
	Attribute::ProxyReadOnly <double, DESCRIPTOR_TABLE > prepmt_nonfinancial_adj;
  inline double	Get_prepmt_nonfinancial_adj() {
		return prepmt_nonfinancial_adj; }
	Attribute::ProxyReadOnly <double, DESCRIPTOR_TABLE > prepmt_nonfinancial_pct;
  inline double	Get_prepmt_nonfinancial_pct() {
		return prepmt_nonfinancial_pct; }
	Attribute::ProxyReadOnly <double, DESCRIPTOR_TABLE > prepmt_nonfinancial_seasonality_addn;
  inline double	Get_prepmt_nonfinancial_seasonality_addn() {
		return prepmt_nonfinancial_seasonality_addn; }
	Attribute::ProxyReadOnly <xstring, DESCRIPTOR_TABLE > prepmt_opt_first_date_mp;
  inline xstring	Get_prepmt_opt_first_date_mp() {
		return prepmt_opt_first_date_mp; }
	Attribute::ProxyReadOnly <StringEnum, DESCRIPTOR_TABLE > prepmt_penalty_defn_mp;
  inline xstring	Get_prepmt_penalty_defn_mp() {
		return prepmt_penalty_defn_mp; }
	Attribute::ProxyReadOnly <double, DESCRIPTOR_TABLE > prepmt_penalty_pct;
  inline double	Get_prepmt_penalty_pct() {
		return prepmt_penalty_pct; }
	Attribute::ProxyReadOnly <double, DESCRIPTOR_TABLE > prepmt_seasoning_since_issue_mult;
  inline double	Get_prepmt_seasoning_since_issue_mult() {
		return prepmt_seasoning_since_issue_mult; }
	Attribute::ProxyReadOnly <double, DESCRIPTOR_TABLE > prin_val_at_issue_mp;
  inline double	Get_prin_val_at_issue_mp() {
		return prin_val_at_issue_mp; }
  ...
  inline void Set_purch_asset_sub_port(const int &v) {
	...
	Attribute::Proxy <StringEnum, DESCRIPTOR_TABLE > purch_defn;
  inline xstring	Get_purch_defn() {
		return purch_defn; }
  inline void Set_purch_defn(const xstring &v) {
		purch_defn.setValue(v); }
	Attribute::ProxyReadOnly <double, DESCRIPTOR_TABLE > rbc_c1_pct_mp;
  inline double	Get_rbc_c1_pct_mp() {
		return rbc_c1_pct_mp; }
	Attribute::ProxyReadOnly <double, DESCRIPTOR_TABLE > refinance_rate_mult_bef_maturity;
  inline double	Get_refinance_rate_mult_bef_maturity() {
		return refinance_rate_mult_bef_maturity; }
	Attribute::ProxyReadOnly <double, DESCRIPTOR_TABLE > refinance_rate_mult_since_issue;
  inline double	Get_refinance_rate_mult_since_issue() {
		return refinance_rate_mult_since_issue; }
	Attribute::ProxyReadOnly <double, DESCRIPTOR_TABLE > refinance_rate_pct;
  inline double	Get_refinance_rate_pct() {
		return refinance_rate_pct; }
	Attribute::ProxyReadOnly <double, DESCRIPTOR_TABLE > refinance_rate_scen_mult;
  inline double	Get_refinance_rate_scen_mult() {
		return refinance_rate_scen_mult; }
  ...
  inline double	Get_refinancing_rate_scen_yr() {
	...
	Attribute::ProxyReadOnly <double, DESCRIPTOR_TABLE > restructure_rate_mult_bef_maturity;
  inline double	Get_restructure_rate_mult_bef_maturity() {
		return restructure_rate_mult_bef_maturity; }
	Attribute::ProxyReadOnly <double, DESCRIPTOR_TABLE > restructure_rate_mult_since_issue;
  inline double	Get_restructure_rate_mult_since_issue() {
		return restructure_rate_mult_since_issue; }
	Attribute::ProxyReadOnly <double, DESCRIPTOR_TABLE > restructure_rate_pct;
  inline double	Get_restructure_rate_pct() {
		return restructure_rate_pct; }
	Attribute::ProxyReadOnly <double, DESCRIPTOR_TABLE > restructure_rate_scen_mult;
  inline double	Get_restructure_rate_scen_mult() {
		return restructure_rate_scen_mult; }
	Attribute::ProxyReadOnly <double, DESCRIPTOR_TABLE > restructure_write_down_pct;
  inline double	Get_restructure_write_down_pct() {
		return restructure_write_down_pct; }
  ...
  inline xstring	Get_seg_id_mp() {
		return seg_id_mp; }
	Attribute::ProxyReadOnly <double, DESCRIPTOR_TABLE > servicing_fee_mp;
  inline double	Get_servicing_fee_mp() {
		return servicing_fee_mp; }
  ...
  inline void Set_msnumelement(const int &v) {
	...
	Attribute::Proxy<Scalar<int>, DESCRIPTOR_TABLE > balloon_pmt_flag;
	Attribute::Proxy<Scalar<int>, DESCRIPTOR_TABLE > balloon_pmt_period;
	...
	Attribute::Proxy<Scalar<double>, DESCRIPTOR_TABLE > foreclosure_write_down_pct_calc;
	Attribute::Proxy<Scalar<int>, DESCRIPTOR_TABLE > gaap_inc_defn;
	Attribute::Proxy<Scalar<int>, DESCRIPTOR_TABLE > gaap_val_defn;
	Attribute::Proxy<Scalar<int>, DESCRIPTOR_TABLE > init_mths_since_issue;
	...
	Attribute::Proxy<Scalar<double>, DESCRIPTOR_TABLE > par_val_at_issue;
	Attribute::Proxy<Scalar<double>, DESCRIPTOR_TABLE > pct_to_use;
	Attribute::Proxy<Scalar<double>, DESCRIPTOR_TABLE > planned_sale_period;
	Attribute::Proxy<Scalar<int>, DESCRIPTOR_TABLE > pmt_freq;
	Attribute::Proxy<Scalar<int>, DESCRIPTOR_TABLE > pmt_mths;
	Attribute::Proxy<Scalar<double>, DESCRIPTOR_TABLE > pmt_rate_at_issue;
	...
	Attribute::Proxy<Scalar<int>, DESCRIPTOR_TABLE > prepmt_first_period;
	Attribute::Proxy<Scalar<int>, DESCRIPTOR_TABLE > prepmt_par_first_period;
	Attribute::Proxy<Scalar<int>, DESCRIPTOR_TABLE > prepmt_penalty_grading_mths;
	Attribute::Proxy<Scalar<double>, DESCRIPTOR_TABLE > prepmt_penalty_related_to_pmt_rate;
	...
	Attribute::Proxy<Scalar<double>, DESCRIPTOR_TABLE > restructure_write_down_pct_calc;
	...
	Attribute::Proxy<Scalar<int>, DESCRIPTOR_TABLE > use_andrew_davidson;
	Attribute::Proxy<Scalar<int>, DESCRIPTOR_TABLE > use_intex_databases_for_mtg;
...
void after_startup(int decrement = 0);
 void copy_names();
 void passDataVariables(MTG_ASSET* target) { passDataVars(target); }

 void mapVariables();

 // External function prototypes

// Detail Log Rebase Reset
...
double category_refinancing_rate(int t, int cal_yr, int cal_mth, int months_to_maturity, int return_rate_basis, int shift_defn, double years_from_payment_to_end_of_payment_month_passed);
...
double pmt_amt(int t, double principal_value, int months_to_maturity, int pmt_freq, double int_rate, int amortzn_period);
...
void rebase_cash_flow(int t, int command, const xstring &caller, const xstring &model_name);

// Setup Balloon Schedule
#line 1 "setup_balloon_sch.mtg_asset.for"
void setup_balloon_sch();

// Setup Existing Asset
#line 1 "setup_existing_asset.mtg_asset.for"
void setup_existing_asset(void);

// Setup intex Submodel Parameters
#line 1 "setup_intex_submodel_parameters.mtg_asset.for"
void setup_intex_submodel_parameters(int t);

// Setup Prepayment Penalty Schedule
#line 1 "setup_prepmt_penalty_sch.mtg_asset.for"
void setup_prepmt_penalty_sch();
...
void setup_purch_inv_asset(int t, int save_assets, int panum, int new_mp_num, StrEnum::EnumValue investment_purpose, int inv_purchase_sub_port, double purch_asset_amt, int &asset_mp_sequence_num);

// Shrink Mortgage Clone
#line 1 "shrink_mtg_clone.mtg_asset.for"
void shrink_mtg_clone(int mp);
...
//factory
static MTG_ASSET* makeThis(int isSubmodel, ModelClass *owner, MTG_ASSET* peer, 
					int mainRebase, const xstring &name, MTG_ASSET_persistent_object* arrayTemplate);

//constructor
MTG_ASSET(const xstring &modelClassName, int isSubmodel, ModelClass *owner, ModelClass *peer, 
...
MTG_ASSET(int columnCount, Descriptor* mocd[], Product* persObj);
...
class MTG_ASSET_persistent_object : public MTG_ASSET {
...
public :
  ...
  bool isPersistentObject() const { return true; }
   ...
   sm_calling_model->subTotalKey(keys);
	...
	void findTargetColumns() {MTG_ASSET::findTargetColumns();}
	void createAllShare() {
		MTG_ASSET::createAllShare();
}
...
//factory
static MTG_ASSET_persistent_object* makeThis(int isSubmodel, ModelClass *owner, MTG_ASSET* peer, 
					int mainRebase, const xstring &name, MTG_ASSET_persistent_object* arrayTemplate, bool fixedArray);

//constructor
MTG_ASSET_persistent_object(const xstring &modelClassName,
