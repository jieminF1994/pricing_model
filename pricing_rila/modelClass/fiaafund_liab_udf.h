...
double fiaafund_liab_combo_strat_ind_par_rate_crbg(int t);

// Status tracker for combo strategy 
double fiaafund_liab_combo_strat_renew_status_crbg(int t);

// Credited Interest 
double fiaafund_liab_credited_int(int t);

// Crediting Buffer Cap 
double fiaafund_liab_crediting_2nd_strat_buffer_cap_aig(int t);

// Crediting Dual Direction Cap 
double fiaafund_liab_crediting_2nd_strat_dual_dir_cap_aig(int t);

// Crediting Cap Rate (Solved from Call Spread) 
double fiaafund_liab_crediting_cap_rate(int t);

// Crediting Dual Direction Cap 
double fiaafund_liab_crediting_dual_dir_cap_aig(int t);

// Crediting Dual Direction Trigger 
double fiaafund_liab_crediting_dual_dir_trigger_crbg(int t);
...
double fiaafund_liab_crediting_rate_chg_threshold_aig(int t);
...
// rate change maximum 
double fiaafund_liab_crediting_rate_max_annual_chg_down_aig(int t);

// rate change maximum 
double fiaafund_liab_crediting_rate_max_annual_chg_up_aig(int t);

// Crediting Secure Cap 
double fiaafund_liab_crediting_secure_cap_aig(int t);
...
double fiaafund_liab_hedge_rila_trading_cost_aig(int t);
...
double fiaafund_liab_init_cap_rate_aig(int t);

// Initial participation rate 
double fiaafund_liab_init_part_rate_aig(int t);
...
// MWV base at BOM: 
double fiaafund_liab_mwv_base_b_aig(int t);

// MWV base at EOM: 
double fiaafund_liab_mwv_base_e_aig(int t);

// MWV base at EOM: 
double fiaafund_liab_mwv_base_e_bef_aig(int t);

// Minimum Withdrawal Value at BOM: 
double fiaafund_liab_mwv_interim_val_b_aig(int t);

// Minimum Withdrawal Value at EOM: 
double fiaafund_liab_mwv_interim_val_e_aig(int t);

// Minimum Withdrawal Value at EOM: 
double fiaafund_liab_mwv_interim_val_e_bef_aig(int t);
...
double fiaafund_liab_opt_budget_renewal_2nd_strat_aig(int t);
...
double fiaafund_liab_renew_into_2nd_strat_status_aig(int t);

// buffer amt 
double fiaafund_liab_rila_buffer_amt_aig(int t);

// Rila Init Opt Cost By Grid 2Nd Strat Aig 
double fiaafund_liab_rila_init_opt_cost_by_grid_2nd_strat_aig(int t);

// Interim Value at beginning of the term 
double fiaafund_liab_rila_int_val_beg_term_bom_aig(int t);

// Interim Value at beginning of the term 
double fiaafund_liab_rila_int_val_beg_term_eom_aig(int t);

// Interim Value b after charge 
double fiaafund_liab_rila_interim_value_b_aig(int t);

// Interim Value 
double fiaafund_liab_rila_interim_value_dapv_e_aig(int t);

// Interim Value eom, after survivorship and wd 
double fiaafund_liab_rila_interim_value_e_aig(int t);

// Interim Value 
double fiaafund_liab_rila_interim_value_e_bef_aig(int t);

// Interim Value 
double fiaafund_liab_rila_interim_value_fiapv_e_aig(int t);

// Interim Value Growth 
double fiaafund_liab_rila_interim_value_growth_aig(int t);

// Interim Value 
double fiaafund_liab_rila_interim_value_tc_e_aig(int t);

// Knockout strategy option cost for interim val 
double fiaafund_liab_rila_knockout_cost_interim_val_e_aig(int t);

// Knockout strategy option cost for interim val at the beginning 
double fiaafund_liab_rila_knockout_cost_interim_val_init_aig(int t);

// policy month when knockout occurs 
double fiaafund_liab_rila_knockout_mth_aig(int t);

// Status tracker for the knockout strategy 
double fiaafund_liab_rila_knockout_status_bom_aig(int t);

// Status tracker for the knockout strategy 
double fiaafund_liab_rila_knockout_status_eom_aig(int t);

// Rila Opt Cost Beg Strat Term Aig 
double fiaafund_liab_rila_opt_cost_beg_strat_term_aig(int t);

// Rila Opt Cost Bs B Aig 
double fiaafund_liab_rila_opt_cost_bs_b_aig(int t);

// Rila Opt Cost Bs E Aig 
double fiaafund_liab_rila_opt_cost_bs_e_aig(int t);

// Rila option cost based on option grid, BOM 
double fiaafund_liab_rila_opt_cost_by_grid_b_aig(int t);

// Rila option cost based on option grid, EOM 
double fiaafund_liab_rila_opt_cost_by_grid_e_aig(int t);

// Current value high water mark 
double fiaafund_liab_rila_perf_lock_hwm_aig(int t);

// Probability of performance lock 
double fiaafund_liab_rila_perf_lock_prob_aig(int t);

// Status tracker for performance lock 
double fiaafund_liab_rila_perf_lock_status_bom_aig(int t);

// Status tracker for performance lock 
double fiaafund_liab_rila_perf_lock_status_eom_aig(int t);

// SMAX for brownian bridge adjustment 
double fiaafund_liab_rila_smax_brownian_bridge_aig(int t);

// RILA strategy base 
double fiaafund_liab_rila_strat_base_b_aig(int t);

// Rila Strategy Base 
double fiaafund_liab_rila_strat_base_e_aig(int t);

// trading cost for rila at beginning of month 
double fiaafund_liab_rila_trading_cost_pct_bom_aig(int t);

// trading cost for rila at end of month 
double fiaafund_liab_rila_trading_cost_pct_eom_aig(int t);
...
double fiaafund_liab_strategy_return_index_aig(int t);

// Strategy Return based on Index Accounts 
double fiaafund_liab_strategy_return_index_rila_aig(int t);

// Strategy Return from previous index term 
double fiaafund_liab_strategy_return_prior_index_term_aig(int t);

// Strategy Return from previous index term 
double fiaafund_liab_strategy_return_prior_index_term_eom_aig(int t);
...
int  fiaafund_liab_opt_budget_grading_period_aig();
