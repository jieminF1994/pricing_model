#ifndef __BOND_PORTFOLIO_AIG_H_
#define __BOND_PORTFOLIO_AIG_H_
...
class BOND_PORTFOLIO_AIG_persistent_object;
class BOND_PORTFOLIO_AIG : public ModelClass {
...
public :
	...
	size_t sizeofThis() const { return sizeof(BOND_PORTFOLIO_AIG); }
...
int new_asset_rate_tenor_freq; // Global object that stores the new asset rate tenor frequency after expansion
 ...
 // Column Definition Begins
 	ColumnAccessor < mCFStaticData_0 > asset_amt_b_aig;
 	ColumnAccessor < mCFStaticData_0 > asset_amt_e_aig;
 	ColumnAccessor < mCFStaticData_0 > asset_amt_matured_aig;
 	ColumnAccessor < mCFStaticData_0 > asset_amt_new_aig;
 	ColumnAccessor < mCFStaticData_0 > avg_coupon_rt_aig;
 	ColumnAccessor < mCFStaticData_0 > cash_flow_pct_aig;
 	ColumnAccessor < mCFStaticData_0 > coupon_amt_aig;
 	ColumnAccessor < mCFStaticData_0 > duration_curr_asset_aig;
 	ColumnAccessor < mCFStaticData_0 > duration_new_asset_aig;
 	ColumnAccessor < mCFStaticData_0 > duration_target_asset_aig;
 	ColumnAccessor < mCFStaticData_0 > initialize;
 	ColumnAccessor < mCFStaticData_0 > new_money_rate_aig;
 	ColumnAccessor < mCFStaticData_0 > pol_yr;
 	ColumnAccessor < mCFStaticData_0 > startup;
//Column Definition END@2

 // Temporary Table...
_1D_BOND_AIG sm_fia_bond_aig;
BOND_PORTFOLIO_AIG *sm_bond_is;
BOND_PORTFOLIO_AIG *sm_bond_pv;
BOND_PORTFOLIO_AIG *sm_bond_ym;
BOND_PORTFOLIO_AIG *sm_mtg_is;
BOND_PORTFOLIO_AIG *sm_mtg_pv;
BOND_PORTFOLIO_AIG *sm_mtg_ym;
...
#endif	MICROSOFT
	#define DESCRIPTOR_TABLE BOND_PORTFOLIO_AIG::descriptor_0
#ifdef MICROSOFT
#pragma warning(pop)
#endif	MICROSOFT
	Attribute::ProxyReadOnly <double, DESCRIPTOR_TABLE > asset_yld_addn_aig;
  inline double	Get_asset_yld_addn_aig() {
		return asset_yld_addn_aig; }
	Attribute::ProxyReadOnly <int, DESCRIPTOR_TABLE > bond_count_aig;
  inline int	Get_bond_count_aig() {
		return bond_count_aig; }
	Attribute::ProxyReadOnly <StringEnum, DESCRIPTOR_TABLE > cash_flow_pct_defn_aig;
  inline xstring	Get_cash_flow_pct_defn_aig() {
		return cash_flow_pct_defn_aig; }
  ...
  inline xstring	Get_coupon_freq_defn_aig() {
	...
	Attribute::ProxyReadOnly <double, DESCRIPTOR_TABLE > new_asset_duration_floor_aig;
  inline double	Get_new_asset_duration_floor_aig() {
		return new_asset_duration_floor_aig; }
	Attribute::ProxyReadOnly <xstring, DESCRIPTOR_TABLE > new_asset_rate_id_aig;
  inline xstring	Get_new_asset_rate_id_aig() {
		return new_asset_rate_id_aig; }
	Attribute::ProxyReadOnly <xstring, DESCRIPTOR_TABLE > new_asset_rate_tenors_aig;
  inline xstring	Get_new_asset_rate_tenors_aig() {
		return new_asset_rate_tenors_aig; }
	Attribute::ProxyReadOnly <StringEnum, DESCRIPTOR_TABLE > new_asset_rate_tenors_expand_defn_aig;
  inline xstring	Get_new_asset_rate_tenors_expand_defn_aig() {
		return new_asset_rate_tenors_expand_defn_aig; }
	Attribute::ProxyReadOnly <StringEnum, DESCRIPTOR_TABLE > new_money_rate_defn_aig;
  inline xstring	Get_new_money_rate_defn_aig() {
		return new_money_rate_defn_aig; }
	Attribute::ProxyReadOnly <StringEnum, DESCRIPTOR_TABLE > print_debug_output_defn_aig;
  inline xstring	Get_print_debug_output_defn_aig() {
		return print_debug_output_defn_aig; }
	Attribute::ProxyReadOnly <double, DESCRIPTOR_TABLE > target_asset_duration_aig;
  inline double	Get_target_asset_duration_aig() {
		return target_asset_duration_aig; }
  ...
  inline void Set_msnumelement(const int &v) {
	...
	Attribute::Proxy<Scalar<int>, DESCRIPTOR_TABLE > initialize_bond_portfolio_aig;
...
void after_startup(int decrement = 0);
 void copy_names();
 void passDataVariables(BOND_PORTFOLIO_AIG* target) { passDataVars(target); }
...
double get_new_asset_duration_aig(int t, int tenor);

// Get New Asset Duration Curve
#line 1 "get_new_asset_duration_curve_aig.bond_portfolio_aig.for"
vector<double> get_new_asset_duration_curve_aig(int t);

// Get Par Yield
#line 1 "get_par_yield_aig.bond_portfolio_aig.for"
double get_par_yield_aig(int t, int tenor);

// Get Par Yield Curve
#line 1 "get_par_yield_curve_aig.bond_portfolio_aig.for"
vector<double> get_par_yield_curve_aig(int t);

// Get Spot Price
#line 1 "get_spot_price_aig.bond_portfolio_aig.for"
double get_spot_price_aig(int t, int tenor);

// Get Spot Price Curve
#line 1 "get_spot_price_curve_aig.bond_portfolio_aig.for"
vector<double> get_spot_price_curve_aig(int t);

// Initializes New Asset Durations
#line 1 "initialize_new_asset_durations_aig.bond_portfolio_aig.for"
void initialize_new_asset_durations_aig(void);

// Initializes Par Yields
#line 1 "initialize_par_yields_aig.bond_portfolio_aig.for"
void initialize_par_yields_aig(void);

// Initializes Spot Prices
#line 1 "initialize_spot_prices_aig.bond_portfolio_aig.for"
void initialize_spot_prices_aig(void);

// Print Initialized Table
#line 1 "print_debug_initialized_table_aig.bond_portfolio_aig.for"
void print_debug_initialized_table_aig(xstring file_path, vector< vector <double> > table);

// Print Debug Output
#line 1 "print_debug_output_aig.bond_portfolio_aig.for"
void print_debug_output_aig(void);


//factory
static BOND_PORTFOLIO_AIG* makeThis(int isSubmodel, ModelClass *owner, BOND_PORTFOLIO_AIG* peer, 
					int mainRebase, const xstring &name, BOND_PORTFOLIO_AIG_persistent_object* arrayTemplate);

//constructor
BOND_PORTFOLIO_AIG(const xstring &modelClassName, int isSubmodel, ModelClass *owner, ModelClass *peer, 
...
BOND_PORTFOLIO_AIG(int columnCount, Descriptor* mocd[], Product* persObj);
...
class BOND_PORTFOLIO_AIG_persistent_object : public BOND_PORTFOLIO_AIG {
...
public :
  ...
  bool isPersistentObject() const { return true; }
   ...
   sm_calling_model->subTotalKey(keys);
	...
	void findTargetColumns() {BOND_PORTFOLIO_AIG::findTargetColumns();}
	void createAllShare() {
		BOND_PORTFOLIO_AIG::createAllShare();
}
...
public :
	...
	~BOND_PORTFOLIO_AIG_persistent_object();
...
//factory
static BOND_PORTFOLIO_AIG_persistent_object* makeThis(int isSubmodel, ModelClass *owner, BOND_PORTFOLIO_AIG* peer, 
					int mainRebase, const xstring &name, BOND_PORTFOLIO_AIG_persistent_object* arrayTemplate, bool fixedArray);

//constructor
BOND_PORTFOLIO_AIG_persistent_object(const xstring &modelClassName,
