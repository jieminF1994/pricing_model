...
strategy_return_switch_start_duration_aig = t_high;     // 20180930 MTC
 ...
 // Column Definition Begins
 	...
 	ColumnAccessor < mCFStaticData_0 > combo_strat_ind_par_rate_crbg;
 	ColumnAccessor < mCFStaticData_0 > combo_strat_renew_status_crbg;
 	ColumnAccessor < mCFStaticData_0 > credited_int;
 	ColumnAccessor < mCFStaticData_0 > crediting_2nd_strat_buffer_cap_aig;
 	ColumnAccessor < mCFStaticData_0 > crediting_2nd_strat_dual_dir_cap_aig;
 	ColumnAccessor < mCFStaticData_0 > crediting_cap_rate;
 	ColumnAccessor < mCFStaticData_0 > crediting_dual_dir_cap_aig;
 	ColumnAccessor < mCFStaticData_0 > crediting_dual_dir_trigger_crbg;
 	...
 	ColumnAccessor < mCFStaticData_0 > crediting_rate_chg_threshold_aig;
 	...
 	ColumnAccessor < mCFStaticData_0 > crediting_rate_max_annual_chg_down_aig;
 	ColumnAccessor < mCFStaticData_0 > crediting_rate_max_annual_chg_up_aig;
 	ColumnAccessor < mCFStaticData_0 > crediting_secure_cap_aig;
 	...
 	ColumnAccessor < mCFStaticData_0 > hedge_rila_trading_cost_aig;
 	...
 	ColumnAccessor < mCFStaticData_0 > init_cap_rate_aig;
 	ColumnAccessor < mCFStaticData_0 > init_part_rate_aig;
 	...
 	ColumnAccessor < mCFStaticData_0 > mwv_base_b_aig;
 	ColumnAccessor < mCFStaticData_0 > mwv_base_e_aig;
 	ColumnAccessor < mCFStaticData_0 > mwv_base_e_bef_aig;
 	ColumnAccessor < mCFStaticData_0 > mwv_interim_val_b_aig;
 	ColumnAccessor < mCFStaticData_0 > mwv_interim_val_e_aig;
 	ColumnAccessor < mCFStaticData_0 > mwv_interim_val_e_bef_aig;
 	...
 	ColumnAccessor < mCFStaticData_0 > opt_budget_renewal_2nd_strat_aig;
 	...
 	ColumnAccessor < mCFStaticData_0 > renew_into_2nd_strat_status_aig;
 	ColumnAccessor < mCFStaticData_0 > rila_buffer_amt_aig;
 	ColumnAccessor < mCFStaticData_0 > rila_init_opt_cost_by_grid_2nd_strat_aig;
 	ColumnAccessor < mCFStaticData_0 > rila_int_val_beg_term_bom_aig;
 	ColumnAccessor < mCFStaticData_0 > rila_int_val_beg_term_eom_aig;
 	ColumnAccessor < mCFStaticData_0 > rila_interim_value_b_aig;
 	ColumnAccessor < mCFStaticData_0 > rila_interim_value_dapv_e_aig;
 	ColumnAccessor < mCFStaticData_0 > rila_interim_value_e_aig;
 	ColumnAccessor < mCFStaticData_0 > rila_interim_value_e_bef_aig;
 	ColumnAccessor < mCFStaticData_0 > rila_interim_value_fiapv_e_aig;
 	ColumnAccessor < mCFStaticData_0 > rila_interim_value_growth_aig;
 	ColumnAccessor < mCFStaticData_0 > rila_interim_value_tc_e_aig;
 	ColumnAccessor < mCFStaticData_0 > rila_knockout_cost_interim_val_e_aig;
 	ColumnAccessor < mCFStaticData_0 > rila_knockout_cost_interim_val_init_aig;
 	ColumnAccessor < mCFStaticData_0 > rila_knockout_mth_aig;
 	ColumnAccessor < mCFStaticData_0 > rila_knockout_status_bom_aig;
 	ColumnAccessor < mCFStaticData_0 > rila_knockout_status_eom_aig;
 	ColumnAccessor < mCFStaticData_0 > rila_opt_cost_beg_strat_term_aig;
 	ColumnAccessor < mCFStaticData_0 > rila_opt_cost_bs_b_aig;
 	ColumnAccessor < mCFStaticData_0 > rila_opt_cost_bs_e_aig;
 	ColumnAccessor < mCFStaticData_0 > rila_opt_cost_by_grid_b_aig;
 	ColumnAccessor < mCFStaticData_0 > rila_opt_cost_by_grid_e_aig;
 	ColumnAccessor < mCFStaticData_0 > rila_perf_lock_hwm_aig;
 	ColumnAccessor < mCFStaticData_0 > rila_perf_lock_prob_aig;
 	ColumnAccessor < mCFStaticData_0 > rila_perf_lock_status_bom_aig;
 	ColumnAccessor < mCFStaticData_0 > rila_perf_lock_status_eom_aig;
 	ColumnAccessor < mCFStaticData_0 > rila_smax_brownian_bridge_aig;
 	ColumnAccessor < mCFStaticData_0 > rila_strat_base_b_aig;
 	ColumnAccessor < mCFStaticData_0 > rila_strat_base_e_aig;
 	ColumnAccessor < mCFStaticData_0 > rila_trading_cost_pct_bom_aig;
 	ColumnAccessor < mCFStaticData_0 > rila_trading_cost_pct_eom_aig;
 	...
 	ColumnAccessor < mCFStaticData_0 > strategy_return_index_aig;
 	ColumnAccessor < mCFStaticData_0 > strategy_return_index_rila_aig;
 	ColumnAccessor < mCFStaticData_0 > strategy_return_prior_index_term_aig;
 	ColumnAccessor < mCFStaticData_0 > strategy_return_prior_index_term_eom_aig;
...
#pragma warning(pop)
#endif	MICROSOFT
	Attribute::ProxyReadOnly <double, DESCRIPTOR_TABLE > cap_rate_dualdir_tricap_crbg;
  inline double	Get_cap_rate_dualdir_tricap_crbg() {
  ...
  inline xstring	Get_crediting_eqt_index() {
	...
	Attribute::ProxyReadOnly <xstring, DESCRIPTOR_TABLE > crediting_eqt_vol_misc_rate_aig;
  inline xstring	Get_crediting_eqt_vol_misc_rate_aig() {
		return crediting_eqt_vol_misc_rate_aig; }
  ...
  inline void Set_inverse_gamma_param_t_aig(const int &v) {
	...
	Attribute::ProxyReadOnly <double, DESCRIPTOR_TABLE > knockout_buffer_aig;
  inline double	Get_knockout_buffer_aig() {
		return knockout_buffer_aig; }
	Attribute::ProxyReadOnly <double, DESCRIPTOR_TABLE > knockout_realloc_yr_aig;
  inline double	Get_knockout_realloc_yr_aig() {
		return knockout_realloc_yr_aig; }
	Attribute::ProxyReadOnly <double, DESCRIPTOR_TABLE > knockout_rebate_aig;
  inline double	Get_knockout_rebate_aig() {
		return knockout_rebate_aig; }
	Attribute::ProxyReadOnly <double, DESCRIPTOR_TABLE > knockout_rebate_opt_bdgt_aig;
  inline double	Get_knockout_rebate_opt_bdgt_aig() {
		return knockout_rebate_opt_bdgt_aig; }
	Attribute::ProxyReadOnly <double, DESCRIPTOR_TABLE > knockout_threshold_aig;
  inline double	Get_knockout_threshold_aig() {
		return knockout_threshold_aig; }
  ...
  inline xstring	Get_lookback_sampling_interval() {
	...
	Attribute::ProxyReadOnly <double, DESCRIPTOR_TABLE > max_annual_rate_chg_down_aig;
  inline double	Get_max_annual_rate_chg_down_aig() {
		return max_annual_rate_chg_down_aig; }
	Attribute::ProxyReadOnly <double, DESCRIPTOR_TABLE > max_annual_rate_chg_up_aig;
  inline double	Get_max_annual_rate_chg_up_aig() {
		return max_annual_rate_chg_up_aig; }
	Attribute::ProxyReadOnly <double, DESCRIPTOR_TABLE > max_sc_rate_decrease_aig;
  inline double	Get_max_sc_rate_decrease_aig() {
		return max_sc_rate_decrease_aig; }
	Attribute::ProxyReadOnly <double, DESCRIPTOR_TABLE > par_rate_combo_strat_crbg;
  inline double	Get_par_rate_combo_strat_crbg() {
		return par_rate_combo_strat_crbg; }
  ...
  inline double	Get_pct_to_hedge() {
		return pct_to_hedge; }
	Attribute::ProxyReadOnly <double, DESCRIPTOR_TABLE > perf_lock_auto_lock_election_rt_aig;
  inline double	Get_perf_lock_auto_lock_election_rt_aig() {
		return perf_lock_auto_lock_election_rt_aig; }
	Attribute::ProxyReadOnly <double, DESCRIPTOR_TABLE > perf_lock_fixed_rt_aig;
  inline double	Get_perf_lock_fixed_rt_aig() {
		return perf_lock_fixed_rt_aig; }
	Attribute::ProxyReadOnly <double, DESCRIPTOR_TABLE > perf_lock_gamma_param_alpha_aig;
  inline double	Get_perf_lock_gamma_param_alpha_aig() {
		return perf_lock_gamma_param_alpha_aig; }
	Attribute::ProxyReadOnly <double, DESCRIPTOR_TABLE > perf_lock_gamma_param_beta_aig;
  inline double	Get_perf_lock_gamma_param_beta_aig() {
		return perf_lock_gamma_param_beta_aig; }
	Attribute::ProxyReadOnly <double, DESCRIPTOR_TABLE > perf_lock_max_val_rt_aig;
  inline double	Get_perf_lock_max_val_rt_aig() {
		return perf_lock_max_val_rt_aig; }
	Attribute::ProxyReadOnly <double, DESCRIPTOR_TABLE > perf_lock_non_util_rt_multi_yr_aig;
  inline double	Get_perf_lock_non_util_rt_multi_yr_aig() {
		return perf_lock_non_util_rt_multi_yr_aig; }
	Attribute::ProxyReadOnly <double, DESCRIPTOR_TABLE > perf_lock_non_util_rt_one_yr_aig;
  inline double	Get_perf_lock_non_util_rt_one_yr_aig() {
		return perf_lock_non_util_rt_one_yr_aig; }
	Attribute::ProxyReadOnly <double, DESCRIPTOR_TABLE > perf_lock_suff_val_rt_aig;
  inline double	Get_perf_lock_suff_val_rt_aig() {
		return perf_lock_suff_val_rt_aig; }
  ...
  inline void Set_renewal_surr_chg_offest_aig(const double &v) {
	...
	Attribute::ProxyReadOnly <double, DESCRIPTOR_TABLE > rila_opt_inefficiency;
  ...
  inline double	Get_strategy_term_floor_aig() {
	...
	Attribute::ProxyReadOnly <double, DESCRIPTOR_TABLE > trigger_strat_min_index_chg_aig;
  inline double	Get_trigger_strat_min_index_chg_aig() {
		return trigger_strat_min_index_chg_aig; }
  ...
  inline void Set_msnumelement(const int &v) {
	...
	Attribute::Proxy<Scalar<int>, DESCRIPTOR_TABLE > opt_budget_grading_period_aig;
...
// Barrier option pricer- up and out
#line 1 "barrier_up_and_out_opt_val_aig.fiaafund_liab.for"
double barrier_up_and_out_opt_val_aig( double underlying_price, double strike_price, double rebate, double barrier_rate, double yrs_to_expiry, double vol, double risk_free_rate, double payout_rate, int call_or_put);

// barrier_up_out_digital_opt_val_aig
#line 1 "barrier_up_out_digital_opt_val_aig.fiaafund_liab.for"
double barrier_up_out_digital_opt_val_aig( double underlying_price, double rebate, double barrier_rate, double yrs_to_expiry, double vol, double risk_free_rate, double payout_rate);
...
double cap_solver_point_to_point_aig(int t, double buffer_amt, double floor_amt);
...
// Current Option Definition Translation Function
#line 1 "current_opt_defn_func_aig.fiaafund_liab.for"
StrEnum::EnumValue current_opt_defn_func_aig(int option_flag);

// Get Buffer Rate Aig
#line 1 "get_buffer_rate_aig.fiaafund_liab.for"
double get_buffer_rate_aig(double rebate, double barrier, double strategy_term, double vol, double rf_rate_cv, double dividend_yld, double cost);

// Get option price from ESG:
#line 1 "get_option_price_aig.fiaafund_liab.for"
double get_option_price_aig(
	int projection_month, double strike, StrEnum::EnumValue opt_defn, int option_duration_mths, int input_strike_period_mths, int knockout = 0);
...
double get_secure_cap_rate_aig(double buffer, double strategy_term, double price_zcb, double vol_param, double rf_rate_cv, double dividend_yld, double cost);
...
double index_val_calc_absolute(int t);

// Calculates RILA interim value
#line 1 "interim_value_calc_aig.fiaafund_liab.for"
double interim_value_calc_aig(int t, double portion_remaining_time, double initial_option_price, double option_portfolio_value_current);

// inverse of cumulative nomal distribution
#line 1 "inv_cumul_normal_aig.fiaafund_liab.for"
double inv_cumul_normal_aig(double p);
...
// Opt Budget Renewal Calc Aig
#line 1 "opt_budget_renewal_calc_aig.fiaafund_liab.for"
double opt_budget_renewal_calc_aig(int t, double init_opt_cost, double opt_budget_tgt, double init_annuity_factor, double curr_annuity_factor);

// Opt Budget Tgt Calc Aig
#line 1 "opt_budget_tgt_calc_aig.fiaafund_liab.for"
double opt_budget_tgt_calc_aig(int t, double init_opt_cost, double init_strat_term, double curr_strat_term);
...
// Table-driven participation rate solver:
#line 1 "part_rate_solver_alt_model_aig.fiaafund_liab.for"
double part_rate_solver_alt_model_aig(int t);

// Iterative participation rate solve
#line 1 "part_rate_solver_with_cap_crbg.fiaafund_liab.for"
double part_rate_solver_with_cap_crbg(int t, double option_budget, double short_put, double long_call, double cap_rate = 0., double strat_term_mths = 0.);

// base option price for secure cap strategy
#line 1 "secure_cap_base_opt_price_aig.fiaafund_liab.for"
double secure_cap_base_opt_price_aig(double x, double yrs_to_expiry, double vol, double risk_free_rate, double payout_rate, double k, double k_c, double k_b);

// option price for secure cap strategy
#line 1 "secure_cap_final_opt_val_aig.fiaafund_liab.for"
double secure_cap_final_opt_val_aig(double cap, double buffer, double portion_remaining_time, double strat_term, 
